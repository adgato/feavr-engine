...
{
    void ScreenRaycastPass::Init(VulkanEngine* engine)
    {
        this->engine = engine;
    ...
    void ScreenRaycastPass::Draw(const VkCommandBuffer cmd, const std::span<Mesh>& meshes)
    {
    ...
    void ScreenRaycastPass::Destroy()
    {
